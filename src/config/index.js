...
module.exports = {
  ...
  networks: {
    bsc: {
      chainId: 56,
      rpc: (process.env.BSC_RPC || 'https://bsc-dataseed.binance.org,https://bsc-dataseed1.defibit.io,https://bsc-dataseed1.ninicoin.io,https://1rpc.io/bsc,https://rpc.ankr.com/bsc,https://bsc.publicnode.com').split(',')[0].trim(),
    ...
    polygon: {
      chainId: 137,
      rpc: (process.env.POLYGON_RPC || 'https://polygon-bor-rpc.publicnode.com,https://polygon-mainnet.public.blastapi.io,https://polygon.llamarpc.com,https://rpc.ankr.com/polygon/public,https://polygon.meowrpc.com,https://polygon.drpc.org,https://1rpc.io/polygon,https://rpc-mainnet.maticvigil.com,https://polygon-rpc.com').split(',')[0].trim(),
